	...
	ProcessPageInclude(page, PHJSClass,callback, exportVariables) {
		...
		if (!fs.existsSync(page)) {
			...
			if (fs.statSync(page).isDirectory()) {
				...
				let PHJS2 = new PHJSClass(this.PHJS.args,[],this.PHJS.header,this.PHJS.uri,this.PHJS.host,this.PHJS.referer,this.PHJS.libs,o.getPath(page),o.getFileName(page),this.PHJS.ipsrc,this.PHJS.session,this.PHJS.varsToPass,this.PHJS.global,this);
