const rfs = require('require-from-string'),
	  ...
	  util = require("util"),
	  remplace = require(__dirname + "/functions.js").remplace,
	  genconf = require(__dirname + "/functions.js").genconf,
	  getargs = require(__dirname + "/functions.js").getargs,
	  isAuthorized = require(__dirname + "/functions.js").isAuthorized,
	  RedirectedTo = require(__dirname + "/functions.js").RedirectedTo,
	  asMIME = require(__dirname + "/functions.js").asMIME;
