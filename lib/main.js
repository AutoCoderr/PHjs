...
/*const remplace = functions.remplace,

	genconf = functions.genconf,

	getargs = functions.getargs,

	isAuthorized = functions.isAuthorized,

	RedirectedTo = functions.RedirectedTo,

	asMIME = functions.asMIME,

	getPath = functions.getPath,

	getFileName = functions.getFileName,

	ProcessPageInclude = functions.ProcessPageInclude,

	copyDict = functions.copyDict,

	logupload = functions.logupload,

	equal = functions.equal,

	toMin = functions.toMin,

	canUpload = functions.canUpload,

	lenDict = functions.lenDict,

	countOccu = functions.countOccu,

	openInstead = functions.openInstead,

	phjsFileToJsFunc = functions.phjsFileToJsFunc,

	log = functions.log,

	cacheFiles = functions.cacheFiles,

	logFileNames = functions.logFileNames;*/
